    ...
    <footer className=" mt-20 backdrop-blur-sm">
      <div className="w-full p-4 md:py-8">
        ...
        <p className="mb-4 text-xl text-justify">
          I do not own any of the images, videos, gifs and audio used in this
          website. This website is not for commercial use. It is purely to
          demonstrate frontend capabilities. Credit for the visual content is
          listed in the{" "}
          <a
