  ...
  return (
    <section className="relative min-h-screen z-10 " id="products">
      ...
      <section className=" sm:flex ">
        ...
        <section className="sm:w-[30%] lmd:w-[50%] lg:w-[30%] flex flex-col sm:h-screen">
          <section className="grid grid-cols-4 gap-4 py-3 sm:py-0 sm:h-full lmd:h-fit sm:grid-cols-1 lmd:grid-rows-flow lmd:grid-cols-flow w-[100%]  mx-auto lmd:justify-center lg:justify-start">
